...
<body class="bg-gray-100 min-h-screen flex flex-col items-center justify-center py-12 px-4">
    ...
    <div class="bg-white rounded-2xl shadow-md w-full max-w-sm px-8 py-10">
        ...
        <button type="button" id="google-signin-btn"
            class="w-full flex items-center justify-center gap-3 border border-gray-300 rounded-lg px-4 py-2.5 text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 transition mb-5">
        ...
        <!-- Primary CTA Button -->
        <button type="button" id="google-signin-btn-main"
    ...
    <script>
        ...
        document.getElementById('google-signin-btn-main').addEventListener('click', handleGoogleSignIn);
    </script>
</body>
</html>